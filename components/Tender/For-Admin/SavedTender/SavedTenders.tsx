...
import { ISavedTender, ISavedTenderCard } from "@/Types/Tender-Types";
import SavedTenderCard from "@/components/Tender/For-Admin/SavedTender/SavedTenderCard";
      ...
      <div className='max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 pb-[3rem]'>
        ...
        <div>
          <InfiniteScroll
            ...
            pageRef={pageRef}>
            {data && data?.savedTenders.length > 0 && (
              <Link
                href='/admin/create'
