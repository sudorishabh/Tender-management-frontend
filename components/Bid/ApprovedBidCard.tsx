...
import { IApprovedBidCard } from "@/Redux/bid/bidApi";

interface BidCardProps {
  bid: IApprovedBidCard;
}
        ...
        <CardContent className='p-0'>
          <div className='flex flex-col md:flex-row w-full'>
            ...
            <div className='p-4 md:p-6 md:w-2/3 flex flex-col md:flex-row'>
              ...
              <div className='mt-4 md:mt-0 md:ml-4 flex flex-row md:flex-col items-center md:justify-between'>
                <Badge
                  className={cn(
                ...
                <div className='flex items-center justify-end mt-3'>
                  <Link href={`/vendor-board/qualified/${bid.id}`}>
                    <Button
                      variant='ghost'
                      className='text-accent hover:text-accent/80 bg-accent/5'>
