...
interface Props {
  ...
  setIsTermServiceChecked: (val: boolean) => void;
  isAcceptPrivacyChecked: boolean;
  setIsAcceptPrivacyChecked: (val: boolean) => void;
  isBusinessEthicsChecked: boolean;
  setIsBusinessEthicsChecked: (val: boolean) => void;
  isAgreementFormErr: {
    termErr: boolean;
    accPrivacyErr: boolean;
    businessEthicsErr: boolean;
  };
  handleAgreementForm: () => void;
}

const Agreement: FC<Props> = ({
  isTermServiceChecked,
  setIsTermServiceChecked,
  isAcceptPrivacyChecked,
  setIsAcceptPrivacyChecked,
  isBusinessEthicsChecked,
  setIsBusinessEthicsChecked,
  isAgreementFormErr,
  handleAgreementForm,
}) => {
  return (
          ...
          <div className='space-y-6'>
            <div className='bg-blue-50 p-4 rounded-lg border border-blue-200 flex items-start gap-3'>
              ...
              <div className='text-sm text-gray-700'>
                ...
                <p>
                  Please read the agreement carefully. By accepting these terms,
                  you agree to comply with all platform policies. After
